...
func newClient(rootSDK *CipherSwarmAgentSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Client {
	return &Client{
		rootSDK:          rootSDK,
...
// GetHealth - Health check (unauthenticated)
...
func (s *Client) GetHealth(ctx context.Context, opts ...operations.Option) (*operations.GetHealthResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/client/health")
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetHealthResponseBody
	...
	case httpRes.StatusCode == 503:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out sdkerrors.GetHealthResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
