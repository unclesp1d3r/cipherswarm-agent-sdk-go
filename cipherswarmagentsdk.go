...
// Generated from OpenAPI doc version 1.3 and generator version 2.869.25
...
func New(opts ...SDKOption) *CipherSwarmAgentSDK {
	sdk := &CipherSwarmAgentSDK{
		SDKVersion: "0.9.2",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.9.2 2.869.25 1.3 github.com/unclesp1d3r/cipherswarm-agent-sdk-go",
